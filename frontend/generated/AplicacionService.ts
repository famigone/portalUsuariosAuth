...
async function findAplicacionesByPerfiles_Id_1(perfilId: number, init?: EndpointRequestInit_1): Promise<Array<Aplicacion_1>> { return client_1.call("AplicacionService", "findAplicacionesByPerfiles_Id", { perfilId }, init); }
...
export { count_1 as count, delete_1 as delete, findAllAplicaciones_1 as findAllAplicaciones, findAllAplicacionesUsuario_1 as findAllAplicacionesUsuario, findAplicacionesByPerfiles_Id_1 as findAplicacionesByPerfiles_Id, get_1 as get, list_1 as list, save_1 as save };
