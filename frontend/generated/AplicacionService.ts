...
async function findAplicacionesByPerfilId_1(perfilId: number, init?: EndpointRequestInit_1): Promise<Array<Aplicacion_1>> { return client_1.call("AplicacionService", "findAplicacionesByPerfilId", { perfilId }, init); }
...
export { count_1 as count, delete_1 as delete, findAllAplicaciones_1 as findAllAplicaciones, findAllAplicacionesUsuario_1 as findAllAplicacionesUsuario, findAplicacionesByPerfilId_1 as findAplicacionesByPerfilId, get_1 as get, list_1 as list, save_1 as save };
